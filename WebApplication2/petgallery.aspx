<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="petgallery.aspx.cs" Inherits="WebApplication2.petgallery" %>
            ...
            <div class="col-md-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ADOPETDBConnectionString8 %>" SelectCommand="SELECT [Pet_type], [Pet_breed], [Age], [Owner_id], [Pet_description], [Contact], [Pet_image] FROM [pettb]"></asp:SqlDataSource>
                                <div class="col">
